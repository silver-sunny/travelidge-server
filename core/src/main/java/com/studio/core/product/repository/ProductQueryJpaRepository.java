...
import com.studio.core.product.dto.product.GetProductSortReviewTableResponseDto;
import com.studio.core.product.dto.product.GetProductTableResponseDto;
import com.studio.core.product.dto.product.QGetProductClientDetailResponseDto;
import com.studio.core.product.dto.product.QGetProductDetailResponseDto;
import com.studio.core.product.dto.product.QGetProductHomeTableResponseDto;
import com.studio.core.product.dto.product.QGetProductSortReviewTableResponseDto;
import com.studio.core.product.dto.product.QGetProductTableResponseDto;
...
public class ProductQueryJpaRepository {
    ...
    public Page<GetProductHomeTableResponseDto> getBestProductMore(Long memberNo,
        ...
        List<GetProductHomeTableResponseDto> content = queryFactory
            ...
            .from(productEntity)
            .leftJoin(orderEntity).on(productEntity.id.eq(orderEntity.product.id))
            .where(condition)
