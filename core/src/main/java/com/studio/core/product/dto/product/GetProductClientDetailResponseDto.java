...
public class GetProductClientDetailResponseDto {
    ...
    @QueryProjection
    public GetProductClientDetailResponseDto(Long id, String productName, Long price, Long discountRate, Long stock, ProductState productState, Channels channel, String channelProductId, String pri, List<String> pdi, String description, LocalDateTime createAt, LocalDateTime updateAt, Boolean isFavorite) {
        this.id = id;
