...
@Data
@Getter
@Schema(description = "전체 상품")
public class GetProductTableResponseDto {
    ...
    @QueryProjection
    public GetProductTableResponseDto(Long id, String productName, Long price, Long discountRate, Long stock, ProductState productState, Channels channel, String channelProductId, String pri, String description, LocalDateTime createAt, LocalDateTime updateAt) {
        this.id = id;
