...
public record AllProductOrdersSearchDto(
    ...
    @Schema(description = "주문상태") ProductOrderState productOrderState,
    @Schema(description = "취소/반품 상태") CancelOrReturnState cancelOrReturnState
) {
}
